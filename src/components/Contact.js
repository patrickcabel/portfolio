    ...
    >
      ...
      <div className="flex flex-row items-center space-x-4">
        <a
          ...
          className=" inline items-center lg:w-[200px] lg:h-[200px]   bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow "
        >
          <img src={email} alt="" />
        </a>
        <a
